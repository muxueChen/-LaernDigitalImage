...
void main()
{
	...
	pointR.x += 0.32 * sin(1.32);
	pointR.y += 0.3 * sin(1.03);
	pointR.z += 0.4 * sin(1.32);
	
	pointG.x += 0.31 * sin(0.92);
	pointG.y += 0.29 * sin(0.99);
	pointG.z += 0.38 * sin(1.24);
	
	pointB.x += 0.33 * sin(1.245);
	pointB.y += 0.3 * sin(1.41);
	pointB.z += 0.41 * sin(1.11);
